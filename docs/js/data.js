...
window.portfolioData = {
  ...
  skills: [
    ...
    { name: 'PLpgSQL', level: 65, category: 'backend' },
    ...
    { name: 'Dockerfile', level: 60, category: 'tools' },
    { name: 'Batchfile', level: 50, category: 'tools' },
    { name: 'Shell', level: 60, category: 'tools' },
    { name: 'CMake', level: 50, category: 'tools' },
